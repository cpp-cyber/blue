...
iptables -A INPUT -p tcp --dport 135 -j LOG --log-prefix "Blocked Port 135: " --log-level 7
...
iptables -A INPUT -p tcp --dport 80 -m state --state ESTABLISHED -m u32 --u32 "0>>22&0x3C12=2202" -j ACCEPT